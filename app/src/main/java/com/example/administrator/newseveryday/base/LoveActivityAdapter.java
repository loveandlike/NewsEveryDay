 ...
 */
public class LoveActivityAdapter extends RecyclerView.Adapter<LoveActivityAdapter.ItemView> {
    private Context context;
    private ArrayList<News> datas=new ArrayList<>();
    private RequestQueue mRequestQueue;
    RecyclerView recyclerView;

    public LoveActivityAdapter(Context context, ArrayList<News> datas, RequestQueue requestQueue, RecyclerView recyclerView) {
    ...
    public ItemView onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_list_recycle_love, parent, false);
