 ...
 */
public class MainAdapter1 extends RecyclerView.Adapter<MainAdapter1.ItemView> {
    ...
    public MainAdapter1(Context context,NewsDBUtil dbUtil, RequestQueue requestQueue, RecyclerView recyclerView) {
    ...
    public void onBindViewHolder(ItemView holder, final int position) {
        ...
        holder.tv_title.setText(dbUtil.getNewsList().get(position).getTitle());
        holder.tv_text.setText(dbUtil.getNewsList().get(position).getSummary());
        setImage(holder.icon,dbUtil.getNewsList().get(position).getIcon());
    }
